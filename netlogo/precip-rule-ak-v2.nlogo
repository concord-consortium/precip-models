...
;;  started December 2018, post- initial field-test version v2, May 2019 (to be used in Alaska 2019)
...
to startup
  ...
  set square-to-NW-is-colder-by 3
...
to execute-rules
  ...
  setup
  set light-rain-if-air-moisture-is air-moisture-is-at-least
  let moisture-head-room max-air-moisture - air-moisture-is-at-least
  let moisture-step moisture-head-room / 3    ;divide by 3 because there are 3 levels of rain intensity
  ;print (word "moisture step: " moisture-step)
  ;the threashold variables for light, moderate, and heavy rain were formally under user control. This was too complicated for students. Setting them here, though, allows students to experiment with different rules to
  ; see different amounts of rain depending on were the initial rain threshold is set. It just makes it more interesting, I think.
  ...
  ;print (word "moderate rain: " moderate-rain-if-air-moisture-is " heavy rain: " heavy-rain-if-air-moisture-is )
  let i 0
  while [i < cnt]
  [
    ...
    [
      ifelse (test-squ1-moist >= light-rain-if-air-moisture-is and test-squ1-moist < moderate-rain-if-air-moisture-is)
        [show-light-rain idx]
        [ ifelse (test-squ1-moist >= moderate-rain-if-air-moisture-is and test-squ1-moist < heavy-rain-if-air-moisture-is)
...
to set-temp-slider-unit-change
  ...
  ifelse presently-set-temp-unit = "Fahrenheit"
    [
      set square-to-NW-is-colder-by precision (square-to-NW-is-colder-by * 0.5) 1
    ]
    [
      set square-to-NW-is-colder-by round (square-to-NW-is-colder-by * 1.8)
    ]
