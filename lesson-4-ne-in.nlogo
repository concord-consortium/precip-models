...
to reset-drawing
  cd
  ifelse netlogo-web? [
    ;import-drawing "https://maps.googleapis.com/maps/api/staticmap?center=43,-73.5&zoom=6&format=png&size=500x500&maptype=roadmap&style=feature:road|visibility:off"
    ;import-drawing "https://i.imgur.com/5wOckHv.png"
    ;import-drawing "http://www.freeworldmaps.net/united-states/northeast/northeast-us.jpg"
  ] [
    ;import-drawing "New England Base Map.png"
  ]
